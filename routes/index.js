...
const TOOL_VARIANT_CONTENT = {
  'oversized-t-shirt-mockup-generator': {
    ...
    image: 'https://cdn.cloz-design.com/catalog/20260926-generated-commercial-v1/preview/relaxed-crewneck-drop-shoulder-elbow-sleeve-t-shirt-3d-model-b2e6febd66e6.webp',
    heroModel: { src: 'https://cdn.cloz-design.com/catalog/20260912-approved-v1/glb/relaxed-crewneck-drop-shoulder-elbow-sleeve-t-shirt-3d-model-b2e6febd66e6.glb', alt: 'Relaxed drop-shoulder T-shirt 3D mockup' },
    editorHref: '/3d-models/t-shirt-mockup/relaxed-crewneck-drop-shoulder-elbow-sleeve-t-shirt-3d-model-b2e6febd66e6#design',
    cta: { label: 'Customize Oversized Tee', href: '/3d-models/t-shirt-mockup/relaxed-crewneck-drop-shoulder-elbow-sleeve-t-shirt-3d-model-b2e6febd66e6#design' },
  ...
  'front-and-back-t-shirt-mockup': {
    ...
    image: 'https://cdn.cloz-design.com/catalog/20260926-generated-commercial-v1/preview/crewneck-straight-cut-short-sleeve-t-shirt-3d-model-b42a1ab90447.webp',
    heroModel: { src: 'https://cdn.cloz-design.com/catalog/20260919-tshirt225-cuff-v2/glb/crewneck-straight-cut-short-sleeve-t-shirt-3d-model-b42a1ab90447.glb', alt: 'Crew-neck T-shirt 3D mockup' },
    editorHref: '/3d-models/t-shirt-mockup/crewneck-straight-cut-short-sleeve-t-shirt-3d-model-b42a1ab90447#design',
    cta: { label: 'Create Front and Back Mockup', href: '/3d-models/t-shirt-mockup/crewneck-straight-cut-short-sleeve-t-shirt-3d-model-b42a1ab90447#design' },
  ...
  'polo-shirt-mockup-generator': {
    ...
    image: 'https://cdn.cloz-design.com/catalog/20260926-generated-commercial-v1/preview/relaxed-short-sleeve-polo-shirt-3d-model-d0e4db12e3d6.webp',
    heroModel: { src: 'https://cdn.cloz-design.com/catalog/20260926-tshirt223-qualified-v1/glb/relaxed-short-sleeve-polo-shirt-3d-model-d0e4db12e3d6.glb', alt: 'Short-sleeve polo shirt 3D mockup' },
    editorHref: '/3d-models/t-shirt-mockup/relaxed-short-sleeve-polo-shirt-3d-model-d0e4db12e3d6#design',
    cta: { label: 'Customize Polo Shirt', href: '/3d-models/t-shirt-mockup/relaxed-short-sleeve-polo-shirt-3d-model-d0e4db12e3d6#design' },
  ...
  'long-sleeve-shirt-mockup-generator': {
    ...
    image: 'https://cdn.cloz-design.com/catalog/20260926-generated-commercial-v1/preview/crewneck-straight-cut-long-sleeve-t-shirt-3d-model-e3adf1936b9f.webp',
    heroModel: { src: 'https://cdn.cloz-design.com/catalog/20260926-tshirt226-qualified-v1/glb/crewneck-straight-cut-long-sleeve-t-shirt-3d-model-e3adf1936b9f.glb', alt: 'Long-sleeve crew-neck shirt 3D mockup' },
    editorHref: '/3d-models/t-shirt-mockup/crewneck-straight-cut-long-sleeve-t-shirt-3d-model-e3adf1936b9f#design',
    cta: { label: 'Customize Long Sleeve Shirt', href: '/3d-models/t-shirt-mockup/crewneck-straight-cut-long-sleeve-t-shirt-3d-model-e3adf1936b9f#design' },
  ...
  'streetwear-hoodie-mockup-generator': {
    ...
    image: 'https://cdn.cloz-design.com/catalog/20260926-generated-commercial-v1/preview/cuffed-kangaroo-pocket-pullover-hoodie-3d-model-d2ac2ce28d5e.webp',
    heroModel: { src: 'https://cdn.cloz-design.com/catalog/20260912-approved-v1/glb/cuffed-kangaroo-pocket-pullover-hoodie-3d-model-d2ac2ce28d5e.glb', alt: 'Pullover hoodie 3D mockup' },
    editorHref: '/3d-models/hoodie-mockup/cuffed-kangaroo-pocket-pullover-hoodie-3d-model-d2ac2ce28d5e#design',
    cta: { label: 'Customize Streetwear Hoodie', href: '/3d-models/hoodie-mockup/cuffed-kangaroo-pocket-pullover-hoodie-3d-model-d2ac2ce28d5e#design' },
...
function getToolPage(slug) {
  ...
  const page = variant ? {
    ...
    faq: [
      { question: `Is this ${variant.primaryKeyword.replace(/^free\s+/i, '')} free?`, answer: 'Yes. You can inspect the model, compare colors, upload artwork, and download an unedited preview PNG here. Exporting a finished design from the full editor requires Pro or above.' },
...
router.get('/white-mockups', async (req, res) => {
  ...
  try {
    ...
    res.render('white-mockups', {
      ...
      page: 'white-mockups',
      pageStyles: ['/css/white-mockups.css?v=20260926-hero-gif-v5'],
...
router.get('/mockups', async (req, res) => {
  try {
    ...
    res.render('design-3d', { 
      ...
      page: 'design-3d',
      pageStyles: ['/css/mockups-library.css?v=20260926-3d-icon-label-v6'],
