...
const categoryCopy = {
  '3D clothing models': {
    ...
    description: 'Browse free editable 3D clothing models for online apparel mockups, product render planning, ecommerce visuals, and browser-based fashion design.',
  ...
  'T-shirt': {
    title: 'Free T-Shirt 3D Models for Mockups and Print Placement',
    description: 'Browse free T-shirt 3D models for apparel mockups, print placement tests, product-page previews, and print-on-demand colorway planning.',
    meta: 'Use free editable T-shirt 3D models for online apparel mockups, chest print previews, POD product images, and transparent ecommerce renders.',
  ...
  Hoodie: {
    title: 'Free Hoodie 3D Models for Streetwear Mockups',
    description: 'Browse free hoodie 3D models for streetwear mockups, sweatshirt product previews, sleeve graphics, chest artwork, and ecommerce listing visuals.',
    meta: 'Use free editable hoodie 3D models to preview chest prints, sleeve graphics, oversized streetwear fits, and product-page mockup renders.',
  ...
  Shirt: {
    title: 'Free Shirt 3D Models for Apparel Product Mockups',
    description: 'Browse free shirt 3D models for button shirt mockups, blouse previews, woven top product images, uniform concepts, and fabric pattern testing.',
    meta: 'Use free editable shirt 3D models for button shirt mockups, blouse previews, woven fabric tests, and ecommerce apparel renders.',
  ...
  Top: {
    title: 'Free Top 3D Models for Fashion Mockups',
    description: 'Browse free fashion top 3D models for blouse, tank, woven top, sleeveless top, and casual upper-body apparel mockups.',
    meta: 'Use free editable top 3D models for fashion mockups, blouse previews, tank top product images, and apparel design presentation.',
  ...
  Dress: {
    title: 'Free Dress 3D Models for Fashion Product Mockups',
    description: 'Browse free dress 3D models for one-piece dress mockups, boutique product images, textile print previews, and fashion collection planning.',
    meta: 'Use free editable dress 3D models for one-piece dress mockups, textile print previews, boutique ecommerce images, and fashion renders.',
  ...
  Jacket: {
    title: 'Free Jacket 3D Models for Outerwear Mockups',
    description: 'Browse free jacket 3D models for puffer, leather, casual, and structured outerwear mockups with editable colors and product render previews.',
    meta: 'Use free editable jacket 3D models for outerwear mockups, streetwear previews, material tests, and ecommerce product renders.',
  ...
  Coat: {
    title: 'Free Coat 3D Models for Long Outerwear Mockups',
    description: 'Browse free coat 3D models for long coat, trench, seasonal outerwear, and fashion product previews with editable model surfaces.',
    meta: 'Use free editable coat 3D models for trench coat mockups, long outerwear previews, seasonal product renders, and fashion presentations.',
  ...
  Pants: {
    title: 'Free Pants 3D Models for Bottoms Mockups',
    description: 'Browse free pants 3D models for trouser mockups, casual bottoms previews, fabric direction tests, and ecommerce product renders.',
    meta: 'Use free editable pants 3D models for trouser mockups, bottoms product images, fabric tests, and apparel design previews.',
  ...
  Skirt: {
    title: 'Free Skirt 3D Models for Fashion Mockups',
    description: 'Browse free skirt 3D models for fashion mockups, textile print previews, product-page images, and womenswear collection planning.',
    meta: 'Use free editable skirt 3D models for skirt mockups, fabric pattern previews, womenswear renders, and ecommerce product visuals.',
  ...
  Blazer: {
    title: 'Free Blazer 3D Models for Tailored Apparel Mockups',
    description: 'Browse free blazer 3D models for tailored jacket mockups, suiting previews, structured apparel presentation, and ecommerce renders.',
    meta: 'Use free editable blazer 3D models for tailored mockups, suiting previews, structured fashion renders, and product-page visuals.',
  ...
  Bag: {
    title: 'Free Bag 3D Models for Accessory Mockups',
    description: 'Browse free bag 3D models for fashion accessory mockups, logo placement, product renders, material previews, and ecommerce images.',
    meta: 'Use free editable bag 3D models for accessory mockups, logo placement previews, product renders, and ecommerce visuals.',
  ...
  Hat: {
    title: 'Free Hat 3D Models for Headwear Mockups',
    description: 'Browse free hat and cap 3D models for headwear mockups, logo placement, merchandise previews, and ecommerce product renders.',
    meta: 'Use free editable hat 3D models for cap mockups, headwear logo placement, merch previews, and accessory product renders.',
...
function getCategoryCopy(categoryName) {
  return categoryCopy[categoryName] || {
    title: `Free ${categoryName} 3D Models for Apparel Mockups`,
    description: `Browse free ${categoryName.toLowerCase()} 3D models for apparel mockups, online clothing design, product preview renders, and editable UV-based surface design.`,
    meta: `Use free editable ${categoryName.toLowerCase()} 3D models for online apparel mockups, product visuals, transparent renders, and browser-based clothing design.`,
...
function buildModelCategoryLandingContent(categoryName = '3D clothing models') {
  ...
  return {
    ...
    categories: {
      ...
      title: `Related free 3D model categories for ${lowerName} mockups`,
    ...
    output: {
      eyebrow: 'Use cases',
      title: `Free ${displayName} 3D models for commercial apparel mockups`,
      cards: copy.outputs
    },
    library: {
      eyebrow: 'Model library',
      title: `Start from free editable ${lowerName} models instead of flat mockup templates.`,
      buttonLabel: `Browse Free ${displayName} Models`,
      buttonHref: '/mockups'
    },
    faq: {
      eyebrow: 'FAQ',
      title: `Free ${displayName} 3D model questions`,
      items: [
        { question: `What are free ${lowerName} 3D models best used for?`, answer: `They are best used for ${copy.focus}, ecommerce drafts, design approvals, and apparel presentation visuals.` },
    ...
    cta: {
      ...
      title: `Choose a free ${lowerName} model and create the next apparel mockup.`,
