...
const categoryCopy = {
  ...
  Shirt: {
    title: 'Free Shirt Mockups with Editable 3D Models',
    description: 'Browse free shirt mockups and editable 3D button shirt models for blouse previews, woven top product images, uniform concepts, and fabric pattern testing.',
    meta: 'Use free shirt mockup models for button shirt previews, blouse visuals, woven fabric tests, and ecommerce apparel renders.',
  ...
  Dress: {
    title: 'Free Dress Mockups with Editable 3D Models',
    description: 'Browse free dress mockups and editable 3D one-piece dress models for boutique product images, textile print previews, and fashion collection planning.',
    meta: 'Use free dress mockup models for one-piece dress previews, textile print tests, boutique ecommerce images, and fashion renders.',
  ...
  Jacket: {
    title: 'Free Jacket Mockups with Editable 3D Models',
    description: 'Browse free jacket mockups and editable 3D outerwear models for puffer, leather, casual, and structured product previews.',
    meta: 'Use free jacket mockup models for outerwear previews, streetwear visuals, material tests, and ecommerce product renders.',
  ...
  Coat: {
    title: 'Free Coat Mockups with Editable 3D Models',
    description: 'Browse free coat mockups and editable 3D long outerwear models for trench coat previews, seasonal product renders, and fashion presentations.',
    meta: 'Use free coat mockup models for trench coat previews, long outerwear visuals, seasonal product renders, and fashion presentations.',
  ...
  Pants: {
    title: 'Free Pants Mockups with Editable 3D Models',
    description: 'Browse free pants mockups and editable 3D trouser models for casual bottoms previews, fabric direction tests, and ecommerce product renders.',
    meta: 'Use free pants mockup models for trouser previews, bottoms product images, fabric tests, and apparel design visuals.',
...
function buildModelCategoryLandingContent(categoryName = '3D clothing models') {
  ...
  return {
    ...
    faq: {
      ...
      items: [
        { question: `What are free ${lowerName} mockup models best used for?`, answer: `Use them for ${copy.focus}, ecommerce drafts, design approvals, and apparel presentation visuals.` },
