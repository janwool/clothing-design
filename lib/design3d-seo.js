...
const design3dCategories = [
  ...
  { name: 'Sets', slug: 'sets', sort_order: 95 },
  ...
  { name: 'Socks', slug: 'socks', sort_order: 185 },
...
const categoryCopy = {
  '3D clothing models': {
    title: 'Free Apparel Mockups from 3D Clothing Models',
    description: 'Browse free apparel mockups built from editable 3D clothing models for product render planning, ecommerce visuals, and browser-based fashion design.',
    meta: 'Create free apparel mockups from 3D clothing models for transparent product renders, ecommerce visuals, POD listings, and browser-based clothing previews.',
    ...
    outputs: [
      ...
      { title: 'Category-based model selection', body: 'Start from T-shirts, hoodies, dresses, jackets, pants, tops, skirts, hats, and other garments.' }
    ]
  },
  'T-shirt': {
    title: 'Free T-Shirt Mockups with Editable 3D Models',
    description: 'Browse free T-shirt mockups and editable 3D tee models for print placement tests, product-page previews, and print-on-demand colorway planning.',
    meta: 'Use free T-shirt mockup models for chest print previews, POD product images, transparent ecommerce renders, and browser-based apparel visuals.',
    primaryKeyword: 'T-shirt mockup',
  ...
  Hoodie: {
    title: 'Free Hoodie Mockups with Editable 3D Models',
    description: 'Browse free hoodie mockups and editable 3D sweatshirt models for streetwear previews, sleeve graphics, chest artwork, and ecommerce listing visuals.',
    meta: 'Use free hoodie mockup models to preview chest prints, sleeve graphics, oversized streetwear fits, and product-page renders.',
  ...
  Shirt: {
    title: 'Free Shirt 3D Models & Editable Mockups',
    description: 'Browse free shirt 3D models and editable button-shirt mockups for blouse previews, woven top product images, uniform concepts, and fabric pattern testing.',
    meta: 'Use free shirt 3D models and mockups for button-shirt previews, blouse visuals, woven fabric tests, and ecommerce apparel renders.',
  ...
  Top: {
    title: 'Free Fashion Top Mockups with 3D Models',
    description: 'Browse free fashion top mockups and editable 3D models for blouse, tank, woven top, sleeveless top, and casual upper-body apparel previews.',
    meta: 'Use free top mockup models for fashion previews, blouse visuals, tank top product images, and apparel design presentation.',
  ...
  Sets: {
    title: 'Coordinated Outfit Sets in 3D',
    description: 'Browse matching tops and bottoms as complete 3D outfits, including shirt and trouser, hoodie and shorts, and vest and cargo shorts sets.',
    meta: 'Explore coordinated 3D outfit sets and preview both garments together before choosing colors or artwork.',
    focus: 'coordinated tops and bottoms, matching colors, and complete outfit previews',
    workflowTitle: 'Preview a complete outfit set from every angle',
    outputs: [
      { title: 'Matching colorways', body: 'Compare colors across the top and bottom of a set.' },
      { title: 'Artwork placement', body: 'Review graphics on both garments in one outfit.' },
      { title: 'Outfit product images', body: 'Create a consistent view of the complete set for a product listing.' }
    ]
  },
  Jumpsuit: {
    title: 'Jumpsuit, Romper & Overall 3D Models',
    description: 'Browse editable 3D jumpsuits, rompers, and overalls as complete one-piece garments.',
    meta: 'Explore one-piece 3D garments, including overalls and rompers, for fit, color, and product previews.',
    focus: 'one-piece silhouettes, overall straps, and romper details',
    workflowTitle: 'Review one-piece garments in 3D',
    outputs: [
      { title: 'Whole-garment fit', body: 'Inspect the connection between the bodice and legs.' },
      { title: 'Strap and pocket details', body: 'Compare overall straps, front panels, and pocket placement.' },
      { title: 'Product angles', body: 'Capture front, side, and back views of the full garment.' }
    ]
  },
  Swimwear: {
    title: 'Swimwear 3D Models',
    description: 'Browse editable 3D swimwear models and preview the garment from multiple angles.',
    meta: 'Explore 3D swimsuit models for color, strap, and product-view reviews.',
    focus: 'swimwear shape, strap details, and color previews',
    workflowTitle: 'Review swimwear shape and details in 3D',
    outputs: [
      { title: 'Strap details', body: 'Inspect straps, openings, and front-to-back balance.' },
      { title: 'Color direction', body: 'Compare color options across the full swimsuit.' },
      { title: 'Product views', body: 'Prepare front, side, and back images for review.' }
    ]
  },
  Socks: {
    title: 'Sock 3D Models',
    description: 'Browse ankle, crew, and over-the-knee sock models in 3D.',
    meta: 'Explore 3D sock models for length, cuff, color, and detail previews.',
    focus: 'sock length, cuff details, and color previews',
    workflowTitle: 'Compare sock lengths and details in 3D',
    outputs: [
      { title: 'Length comparison', body: 'Compare ankle, crew, and over-the-knee silhouettes.' },
      { title: 'Cuff and trim', body: 'Inspect cuff shape and decorative details.' },
      { title: 'Product views', body: 'Review each pair from multiple angles.' }
    ]
  },
  Dress: {
    title: 'Free 3D Dress Models & Online Dress Mockups',
    description: 'Browse free 3D dress models and editable online dress mockups for boutique product images, textile print previews, and fashion collection planning.',
    meta: 'Use free 3D dress models and online mockups for one-piece dress previews, textile print tests, boutique ecommerce images, and fashion renders.',
    primaryKeyword: 'online dress mockup',
  ...
  Jacket: {
    title: 'Free Jacket 3D Models & Editable Mockups',
    description: 'Browse free jacket 3D models and editable outerwear mockups for puffer, leather, casual, and structured product previews.',
    meta: 'Use free jacket 3D models and mockups for outerwear previews, streetwear visuals, material tests, and ecommerce product renders.',
    primaryKeyword: 'jacket 3D model',
  ...
  Coat: {
    title: 'Free Coat 3D Models & Editable Mockups',
    description: 'Browse free coat 3D models and editable long-outerwear mockups for trench coat previews, seasonal product renders, and fashion presentations.',
    meta: 'Use free coat 3D models and mockups for trench coat previews, long outerwear visuals, seasonal product renders, and fashion presentations.',
  ...
  Pants: {
    title: 'Free Pants 3D Models & Editable Mockups',
    description: 'Browse free pants 3D models and editable trouser mockups for casual bottoms previews, fabric direction tests, and ecommerce product renders.',
    meta: 'Use free pants 3D models and mockups for trouser previews, bottoms product images, fabric tests, and apparel design visuals.',
    primaryKeyword: '3D pants design model',
  ...
  Skirt: {
    title: 'Free Skirt Mockups with Editable 3D Models',
    description: 'Browse free skirt mockups and editable 3D models for textile print previews, product-page images, and womenswear collection planning.',
    meta: 'Use free skirt mockup models for fabric pattern previews, womenswear renders, ecommerce product visuals, and fashion planning.',
  ...
  Blazer: {
    title: 'Free Blazer Mockups with Editable 3D Models',
    description: 'Browse free blazer mockups and editable 3D tailored jacket models for suiting previews, structured apparel presentation, and ecommerce renders.',
    meta: 'Use free blazer mockup models for tailored previews, suiting visuals, structured fashion renders, and product-page imagery.',
  ...
  Bag: {
    title: 'Free Bag Mockups with Editable 3D Models',
    description: 'Browse free bag mockups and editable 3D accessory models for logo placement, product renders, material previews, and ecommerce images.',
    meta: 'Use free bag mockup models for accessory previews, logo placement tests, product renders, and ecommerce visuals.',
  ...
  Hat: {
    title: 'Free Hat Mockups with Editable 3D Models',
    description: 'Browse free hat and cap mockups with editable 3D models for logo placement, merchandise previews, and ecommerce product renders.',
    meta: 'Use free hat mockup models for cap previews, headwear logo placement, merch visuals, and accessory product renders.',
...
function getCategoryCopy(categoryName) {
  return categoryCopy[categoryName] || {
    title: `Free ${categoryName} Mockups with Editable 3D Models`,
    description: `Browse free ${categoryName.toLowerCase()} mockups with editable 3D models for apparel visuals, product preview renders, and UV-based surface design.`,
    meta: `Use free ${categoryName.toLowerCase()} mockup models for online apparel visuals, transparent product renders, and browser-based clothing design.`,
...
function buildModelCategoryLandingContent(categoryName = '3D clothing models') {
  ...
  const primaryKeyword = copy.primaryKeyword || `${lowerName} mockup model`;
  return {
    workflow: {
      eyebrow: `${displayName} workflow`,
      title: copy.workflowTitle,
      description: `Use this free ${lowerName} mockup category when you need ${copy.focus} without rebuilding a garment scene from scratch.`,
      steps: [
    ...
    categories: {
      ...
      title: `Related free mockup categories for ${lowerName} product visuals`,
      ...
      buttonHref: '/mockups',
      cards: [
        { title: 'T-Shirt', meta: 'Mockup models', href: '/mockups/t-shirt-mockup' },
        { title: 'Hoodie', meta: 'Streetwear models', href: '/mockups/hoodie-mockup' },
        { title: 'Dress', meta: 'Fashion models', href: '/mockups/dress' },
        { title: 'Jacket', meta: 'Outerwear models', href: '/mockups/jacket' }
      ]
    },
    output: {
      eyebrow: 'Use cases',
      title: `Free ${displayName} mockups for commercial apparel visuals`,
      cards: copy.outputs
    },
    library: {
      eyebrow: 'Model library',
      title: `Start from free editable ${lowerName} mockup models instead of flat templates.`,
      buttonLabel: `Browse Free ${displayName} Models`,
      buttonHref: '/mockups'
    },
    faq: {
      eyebrow: 'FAQ',
      title: `Free ${displayName} mockup questions`,
      items: [
        { question: `What can I create with a free ${primaryKeyword}?`, answer: `Use it for ${copy.focus}. It also supports ecommerce drafts, design approvals, and apparel presentation visuals.` },
        { question: 'Can I use these 3D garment models online for free?', answer: `Yes. Open a ${lowerName} model in the browser to review the garment, test colors and artwork, and export a mockup preview.` },
        ...
        { question: 'Do I need desktop 3D software?', answer: 'No. The model viewer, artwork placement workflow, color controls, and mockup export tools run in the browser.' },
    ...
    cta: {
      ...
      title: `Choose a free ${lowerName} mockup model and create the next apparel visual.`,
      description: 'Open a model, test the design direction, and use the preview as a clearer product reference.',
      primaryLabel: `Browse Free ${displayName} Models`,
      primaryHref: '/mockups'
    }
  };
}
...
const modelNameCategoryRules = [
  { pattern: /\bset(?: with .+)?$/i, categories: ['Sets'] },
  { pattern: /\b(overalls?|romper|jumpsuit)\b/i, categories: ['Jumpsuit'] },
  { pattern: /\b(swimsuit|swimwear)\b/i, categories: ['Swimwear'] },
  { pattern: /\bsocks?\b/i, categories: ['Socks'] },
  { pattern: /\bbodysuit\b/i, categories: ['Underwear'] },
  { pattern: /\b(beret|beanie|visor|fedora|newsboy|cloche|tricorn|hat|cap)\b/i, categories: ['Hat'] },
  { pattern: /\bcardigan\b/i, categories: ['Top'] },
  { pattern: /\b(coat|trench|outerwear)\b/i, categories: ['Coat'] },
  { pattern: /\b(hoodie|hooded|sweatshirt|fleece|pullover)\b/i, categories: ['Hoodie'] },
  { pattern: /\b(t-?shirt|tee|polo|henley|turtleneck|base layer)\b/i, categories: ['T-shirt'] },
  { pattern: /\b(blouse|button shirt|button front|woven top|shirt)\b/i, categories: ['Shirt'] },
  ...
  { pattern: /\bblazer\b/i, categories: ['Blazer'] },
  { pattern: /\b(puffer|leather jacket|jacket)\b/i, categories: ['Jacket'] },
  { pattern: /\bheadwear\b/i, categories: ['Hat'] },
